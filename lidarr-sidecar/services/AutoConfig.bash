...
log "DEBUG :: AUTOCONFIG_METADATA=${AUTOCONFIG_METADATA}"
log "DEBUG :: AUTOCONFIG_METADATA_JSON=${AUTOCONFIG_METADATA_JSON}"
...
[ "${AUTOCONFIG_METADATA}" == "true" ] &&
    updateArrConfig "${AUTOCONFIG_METADATA_JSON}" "metadata" "Metadata"
...
[ "${AUTOCONFIG_QUALITYPROFILE}" == "true" ] &&
    updateArrConfig "${AUTOCONFIG_QUALITYPROFILE_JSON}" "qualityprofile" "Quality Profile"
